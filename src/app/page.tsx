          ...
          <TabsContent value="theme-colors">
            <Box mt="6">
              <table className={styles.PlaygroundTable}>
                ...
                <tbody>
                  {baseButtonPropDefs.variant.values.map((variant) => (
                    <tr key={variant}>
            ...
            <Box mt="6">
              <table className={styles.PlaygroundTable}>
                <thead>
                  <tr>
                    <th />
                    {baseButtonPropDefs.radius.values.map((radius) => (
                ...
                <tbody>
                  {baseButtonPropDefs.variant.values.map((variant, index) => (
                    <React.Fragment key={variant}>
                      ...
                      {baseButtonPropDefs.size.values.map((size) => (
                        <tr key={size}>
                          <td>Size {size}</td>
                          {baseButtonPropDefs.radius.values.map((radius) => (
...
function buttonSizeToIconSize(
  buttonSize: (typeof baseButtonPropDefs.size.values)[number]
) {
